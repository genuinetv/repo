...
drxini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.gentv/resources/ivue','addons2.ini.ini'))
...
iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.gentv/resources/ivue','ivuesettings.xml'))
iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.gentv/resources/ivue'))
...
def iVueInt2():
	...
	xbmc.executebuiltin('RunAddon(plugin.video.gentv)')
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("[COLOR red]Genuine [COLOR white]IPTV[/COLOR]","Setting up iVue",'', 'Please Wait')
	...
	dp.create("[COLOR red]Genuine [COLOR white]IPTV[/COLOR]","Locating Files",'', 'Please Wait')
	...
	dp.create("[COLOR red]Genuine [COLOR white]IPTV[/COLOR]","Adding Information",'', 'Please Wait')
	a = open(V_drxaddons2ini).read()
	b = a.replace('<GENUN>',username).replace('<GENPW>',password)
...
def iVueInt():
	...
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("[COLOR red]Genuine [COLOR white]IPTV[/COLOR]","Copying ini",'', 'Please Wait')
...
def amylist_install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("[COLOR red]Genuine [COLOR white]IPTV[/COLOR]","Installing Channel List...",'', 'Please Wait')
...
def drxskin_install(name,url):
    path = xbmc.translatePath(os.path.join('special://home/addons','packages'))
    dp = xbmcgui.DialogProgress()
    dp.create("[COLOR red]Genuine [COLOR white]IPTV[/COLOR]","Installing Durex Skin...",'', 'Please Wait')
...
def install(name,url):
    path = xbmc.translatePath(os.path.join('special://home/addons','packages'))
    dp = xbmcgui.DialogProgress()
    dp.create("[COLOR red]Genuine [COLOR white]IPTV[/COLOR]","Installing iVue TV Guide...",'', 'Please Wait')
